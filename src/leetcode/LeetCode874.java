        ...
        for (int i=0;i<commands.length;i++){
            ...
            if (step>0){
                ...
                for (int j=0;j<step;j++){
                    if (map.containsKey((x+temp[0])+","+(y+temp[1]))){
                        break;
                    }
                    x+=temp[0];
                    y+=temp[1];
